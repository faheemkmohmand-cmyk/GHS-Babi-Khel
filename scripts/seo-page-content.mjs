...
function buildContentHtml(route) {
  ...
  parts.push(
    `<p>This website was independently designed and developed by Muhammad Faheem, a Computer Science student at Government High School Babi Khel (District Mohmand, Khyber Pakhtunkhwa, Pakistan), as a school/community project. Machine-readable facts for AI tools: ${SITE_URL}/llms.txt and ${SITE_URL}/api/ai-data</p>`
  );
