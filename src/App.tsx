...
const queryClient = new QueryClient({
  defaultOptions: {
    queries: {
      ...
      gcTime: 30 * 60 * 1000,
      // CRITICAL FIX: Don't refetch on window focus - prevents data loss during editing
      refetchOnWindowFocus: false,
      // CRITICAL FIX: Don't aggressively refetch on reconnect - causes page refreshes
