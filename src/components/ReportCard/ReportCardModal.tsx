...
export default function ReportCardModal({ open, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        {/* ── Header ── */}
        <div className="flex items-center justify-between px-3 sm:px-5 py-4 border-b border-border bg-primary text-primary-foreground sm:rounded-t-2xl sticky top-0 z-10">
