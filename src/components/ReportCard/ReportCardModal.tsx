                ...
                return (
                  <>
                    ...
                    <button
                      ...
                      disabled={!canCombine}
                      className="w-full px-4 py-3 rounded-xl font-semibold text-white disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 transition-opacity hover:opacity-90"
                      style={{
                        background:
                    ...
                    >
                      ...
                      Combined Report — 9th &amp; 10th ({countA + countB} rolls)
                    </button>
                    {!canCombine && (
