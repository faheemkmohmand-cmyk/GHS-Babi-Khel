  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        {/* ── Sticky header (photo + name + status) ───────────────────────── */}
        <div className="sticky top-0 z-10 bg-card/95 backdrop-blur border-b border-border/60 px-4 sm:px-5 py-3.5 flex items-start gap-3">
          {student?.photo_url ? (
            <img
