...
/* ════════════════════════════════════════════════════════════════════════
   ...
   (z-index: -1): clear glass bubbles drift and gently rise through 3D
   space, each holding a faint glowing math formula (π, ∫, E=mc², √, ∑ …)
   or a science glyph (atom, DNA, geometry). Edges catch a blue↔orange
   iridescent sheen that matches the site's azure/tangerine brand; the
   bubble interior is fully transparent so page content always reads
   cleanly. Scrolling parallaxes the bubbles at depth-dependent speeds;
   tapping anywhere pops the nearest bubble into a tiny gold sparkle and
   a fresh one floats up.
