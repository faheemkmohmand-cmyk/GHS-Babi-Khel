          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 min-w-0 pointer-events-auto">
              ...
              <div className="min-w-0 flex-1">
                ...
                {/* Per-class paper timing — classes mixed into this hall can be
                    sitting different papers at different times (synced from
                    the Exam Date Sheet), not one shared clock for everyone. */}
                  ...
                  {listPlanPaperTimes(plan).map((t, i) => (
                    ...
                    >
                      ...
                      {t.startTime && t.endTime && (
                        <span className="text-white/60">{t.startTime}–{t.endTime}</span>
                      )}
                    </span>
                  ))}
                </div>
