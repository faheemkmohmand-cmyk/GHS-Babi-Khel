    ...
    <div className="rounded-2xl border border-border bg-card overflow-hidden">
      ...
      <div className="flex flex-wrap items-center gap-2 p-3 border-b border-border bg-muted/30">
        ...
        <div className="ml-auto flex flex-wrap gap-1.5">
          ...
          <button onClick={regenerate} className="flex items-center gap-1 text-xs px-2.5 py-1.5 rounded-lg bg-secondary hover:bg-secondary/70 text-foreground transition-colors" title="Regenerate from chapter">
            ...
            {nodeIds.map((id) => {
              ...
              return (
                <g
                  ...
                  style={{
                    opacity: animated ? 1 : 0,
                    transform: animated ? "translate(' + p.x + ', ' + p.y + ') scale(1)" : `translate(${p.x}px, ${p.y}px) scale(0.5)`,
                    transition: `opacity 0.4s ease ${delay}s, transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1) ${delay}s`,
