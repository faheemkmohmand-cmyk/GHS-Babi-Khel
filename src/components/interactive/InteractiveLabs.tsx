...
const SUBJECT_BLOCKS: Record<string, Block[]> = {
  ...
  "computer science": ["code", "english", "conceptmap"], // Added English lab too!
  "computer":    ["code", "english", "conceptmap"],
  "cs":          ["code", "english", "conceptmap"],
  "programming": ["code", "english", "conceptmap"],
  "ict":         ["code", "english", "conceptmap"],
  
  // Statistics
  "statistics":  ["stats", "graph", "conceptmap"],
  
  // English - NEW: Full English Learning Lab!
  "english":     ["english", "code", "conceptmap"],
  "eng":         ["english", "code", "conceptmap"],
  "language":    ["english", "urdu", "conceptmap"],
  "languages":   ["english", "urdu", "conceptmap"],
  
  // Urdu - NEW: Urdu Learning Lab!
  "urdu":        ["urdu", "conceptmap"],
  "اردو":        ["urdu", "conceptmap"],
  
  // Pakistan Studies / Social Studies
  "pakistan studies": ["conceptmap", "english"],
  "pakistanstudies": ["conceptmap", "english"],
  "social studies":  ["conceptmap", "english"],
  "sst":             ["conceptmap", "english"],
  
  // Islamiyat
  "islamiyat":   ["urdu", "conceptmap"],
  "islamiat":    ["urdu", "conceptmap"],
  "islamic":     ["urdu", "conceptmap"],
  
  // General / Other
  "general":     ["conceptmap", "english", "code"],
  "other":       ["conceptmap"],
};
