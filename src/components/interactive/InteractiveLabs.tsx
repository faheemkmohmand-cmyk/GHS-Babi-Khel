...
export type Block =
  ...
  | "solver"       // Math: Mathisun-style step solver
...
const BLOCK_META: Record<Block, { label: string; emoji: string; desc: string }> = {
  ...
  solver:     { label: "Solver",       emoji: "🧮", desc: "Step-by-step quadratic solver" },
  ...
  periodic:   { label: "Periodic Table", emoji: "⚛️", desc: "Tap any element for details" },
  code:       { label: "Code Lab",     emoji: "💻", desc: "Live HTML/CSS/JS playground" },
  conceptmap: { label: "Concept Map",  emoji: "🗺️", desc: "Visual outline of this chapter" },
};
...
const SUBJECT_BLOCKS: Record<string, Block[]> = {
  ...
  "mathematics": ["graph", "solver", "geogebra", "conceptmap"],
  "math":        ["graph", "solver", "geogebra", "conceptmap"],
  "physics":     ["phet", "graph", "conceptmap"],
  "chemistry":   ["periodic", "molecule", "phet", "conceptmap"],
  "biology":     ["phet", "conceptmap"],
