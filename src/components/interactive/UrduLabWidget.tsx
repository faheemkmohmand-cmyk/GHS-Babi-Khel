...
const SHAYARI_COLLECTION: ShayariEntry[] = [
  {
    ...
    explanation: "This famous verse from Asrar-e-Khudi (Secrets of the Self) emphasizes self-belief and personal empowerment. Iqbal encourages us to develop our potential so greatly that even divine destiny seeks our input.",
    theme: "Self-Empowerment / Khudi / خودی"
  },
  {
    poet: "Mirza Ghalib",
