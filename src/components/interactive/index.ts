/**
 * Interactive Labs for GHS Babi Khel Notes
 * — Desmos-style graphing, Mathisun-style solver, GeoGebra, PhET,
 *   3D molecules, periodic table, code playground, concept maps.
 *
 * Each block is lazy-loaded so the main bundle stays light.
 */
