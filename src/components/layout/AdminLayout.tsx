...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "exam-console", label: "Live Exam Console",   emoji: "🖥️" },
...
const searchIndex: { label: string; sublabel?: string; tabId: string }[] = [
  ...
  { label: "Admit Card",       sublabel: "Exam Roll Numbers",    tabId: "exam-rolls" },
  // ── Live Exam Console synonyms ──
  { label: "Console",          sublabel: "Live Exam Console",    tabId: "exam-console" },
  { label: "Live Console",     sublabel: "Live Exam Console",    tabId: "exam-console" },
  { label: "Exam Day",         sublabel: "Live Exam Console",    tabId: "exam-console" },
  { label: "Control Room",     sublabel: "Live Exam Console",    tabId: "exam-console" },
  { label: "Hall Operations",  sublabel: "Live Exam Console",    tabId: "exam-console" },
  { label: "Tally",            sublabel: "Live Exam Console",    tabId: "exam-console" },
  { label: "Absentee",         sublabel: "Live Exam Console",    tabId: "exam-console" },
  { label: "Absentee List",    sublabel: "Live Exam Console",    tabId: "exam-console" },
  { label: "Re-Exam",          sublabel: "Live Exam Console",    tabId: "exam-console" },
  { label: "Invigilation",     sublabel: "Live Exam Console",    tabId: "exam-console" },
  { label: "Paper Countdown",  sublabel: "Live Exam Console",    tabId: "exam-console" },
  { label: "Live Attendance",  sublabel: "Live Exam Console",    tabId: "exam-console" },
];
