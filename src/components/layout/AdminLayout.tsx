...
const searchIndex: { label: string; sublabel?: string; tabId: string }[] = [
  ...
  { label: "Exam Schedule",    sublabel: "Exams · Date Sheet",    tabId: "exams" },
  { label: "Exam Date Sheet",  sublabel: "Exams · Date Sheet",    tabId: "exams" },
  { label: "Exam Roll Numbers",sublabel: "Exams · Roll Numbers",  tabId: "exams" },
  { label: "Admit Card",       sublabel: "Exams · Roll Numbers",  tabId: "exams" },
