...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "seating",     label: "My Seating",       emoji: "🪑" },
...
const searchIndex: { label: string; sublabel?: string; tabId: string }[] = [
  ...
  { label: "Seating",            sublabel: "My Seating",        tabId: "seating" },
  { label: "Exam Seating",       sublabel: "My Seating",        tabId: "seating" },
  { label: "My Seat",            sublabel: "My Seating",        tabId: "seating" },
  { label: "Exam Hall",          sublabel: "My Seating",        tabId: "seating" },
  { label: "Desk",               sublabel: "My Seating",        tabId: "seating" },
  { label: "Room",               sublabel: "My Seating",        tabId: "seating" },
