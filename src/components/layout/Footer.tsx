...
const Footer = () => {
  ...
  return (
    ...
    <footer className="bg-[hsl(160_45%_16%)] dark:bg-[hsl(160_50%_10%)] text-white border-t border-white/10">
          ...
          <div className="col-span-2 md:col-span-2">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-2.5">
                <MapPin className="w-4 h-4 mt-0.5 shrink-0 text-[hsl(160_35%_60%)] dark:text-[hsl(160_35%_55%)]" />
              ...
              {displayPhone && (
                <div className="flex items-center gap-2.5">
                  <Phone className="w-4 h-4 shrink-0 text-[hsl(160_35%_60%)] dark:text-[hsl(160_35%_55%)]" />
                  <a
              ...
              <div className="flex items-center gap-2.5">
                <Mail className="w-4 h-4 shrink-0 text-[hsl(160_35%_60%)] dark:text-[hsl(160_35%_55%)]" />
                <a
