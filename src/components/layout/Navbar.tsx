...
const NAV_SECTIONS: NavSection[] = [
  {
    ...
    tint: "bg-sky-100 text-sky-700 dark:bg-sky-400/15 dark:text-sky-300",
    links: [
  ...
  },
  {
    ...
    tint: "bg-sky-100 text-sky-700 dark:bg-sky-400/15 dark:text-sky-300",
    links: [
      { to: "/news",     label: "News",     icon: Newspaper,   desc: "Stories & latest updates",     tint: "bg-sky-100 text-sky-700 dark:bg-sky-400/15 dark:text-sky-300" },
  ...
  },
  {
    ...
    links: [
      { to: "/online-classes", label: "Online Classes", icon: Video,   desc: "Live & recorded lectures",         tint: "bg-sky-100 text-sky-700 dark:bg-sky-400/15 dark:text-sky-300" },
    ...
    <span
      className={`ml-auto shrink-0 inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-bold ${
        live
          ...
          : "bg-white/90 text-sky-700 border border-white/60"
      }`}    >
