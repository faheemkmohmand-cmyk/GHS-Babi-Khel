                  ...
                  <div className="flex flex-col gap-1.5">
                    {isAdmin && (
                      <Link
                        to="/admin"
                        onClick={() => setOpen(false)}
                        className="flex items-center gap-2.5 px-4 py-3 rounded-xl bg-blue-600 text-white font-semibold text-sm no-underline"
                      >
                    ...
                    <Link
                      to="/dashboard"
                      onClick={() => setOpen(false)}
                      className="flex items-center gap-2.5 px-4 py-3 rounded-xl bg-orange-500 text-white font-semibold text-sm no-underline"
                    >
