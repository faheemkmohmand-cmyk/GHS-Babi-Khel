...
const NAV_SECTIONS: NavSection[] = [
  {
    ...
    tint: "bg-orange-100 text-orange-800 dark:bg-orange-400/15 dark:text-orange-300",
    links: [
      { to: "/about",   label: "About",   icon: Landmark,   desc: "History, mission & facilities",      tint: "bg-orange-100 text-orange-800 dark:bg-orange-400/15 dark:text-orange-300" },
      { to: "/gallery", label: "Gallery", icon: Images,     desc: "Photos & videos of school life",     tint: "bg-orange-100 text-orange-800 dark:bg-orange-400/15 dark:text-orange-300" },
      { to: "/contact", label: "Contact", icon: Mail,       desc: "Address, phone & location map",      tint: "bg-orange-100 text-orange-800 dark:bg-orange-400/15 dark:text-orange-300" },
      { to: "/faq",     label: "FAQs",    icon: HelpCircle, desc: "Answers to common questions",        tint: "bg-orange-100 text-orange-800 dark:bg-orange-400/15 dark:text-orange-300" },
    ],
  },
  {
    id: "news",
    ...
    tint: "bg-orange-100 text-orange-800 dark:bg-orange-400/15 dark:text-orange-300",
    links: [
      { to: "/news",     label: "News",     icon: Newspaper,   desc: "Stories & latest updates",     tint: "bg-orange-100 text-orange-800 dark:bg-orange-400/15 dark:text-orange-300" },
      { to: "/notices",  label: "Notices",  icon: Megaphone,   desc: "Official announcements",       tint: "bg-orange-100 text-orange-800 dark:bg-orange-400/15 dark:text-orange-300" },
      { to: "/calendar", label: "Calendar", icon: CalendarDays, desc: "Events & academic dates",     tint: "bg-orange-100 text-orange-800 dark:bg-orange-400/15 dark:text-orange-300" },
    ],
  },
  {
    id: "results",
    ...
    tint: "bg-orange-100 text-orange-800 dark:bg-orange-400/15 dark:text-orange-300",
    links: [
      { to: "/results",   label: "Results",   icon: Trophy, desc: "Exam results & DMCs",           tint: "bg-orange-100 text-orange-800 dark:bg-orange-400/15 dark:text-orange-300" },
      { to: "/merit-list", label: "Merit List", icon: Medal, desc: "Toppers & position holders",   tint: "bg-orange-100 text-orange-800 dark:bg-orange-400/15 dark:text-orange-300" },
    ],
  },
  {
    id: "academics",
    ...
    tint: "bg-orange-100 text-orange-800 dark:bg-orange-400/15 dark:text-orange-300",
    links: [
      { to: "/online-classes", label: "Online Classes", icon: Video,   desc: "Live & recorded lectures",         tint: "bg-orange-100 text-orange-800 dark:bg-orange-400/15 dark:text-orange-300" },
      { to: "/notes",          label: "Notes",          icon: BookOpen, desc: "Study notes by class & subject",   tint: "bg-orange-100 text-orange-800 dark:bg-orange-400/15 dark:text-orange-300" },
      { to: "/library",        label: "Library",        icon: Library,  desc: "Books & reading resources",        tint: "bg-orange-100 text-orange-800 dark:bg-orange-400/15 dark:text-orange-300" },
    ],
  },
];
...
const rollSlipItem: NavLinkItem = {
  ...
  desc: "Find, download & share your slip", tint: "bg-orange-100 text-orange-800 dark:bg-orange-400/15 dark:text-orange-300",
};
    ...
    <span
      className={`ml-auto shrink-0 inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-bold ${
        live
          ...
          : "bg-white/90 text-orange-700 border border-white/60"
      }`}    >
                          ...
                          {section.id === "results" && (
                            ...
                            >
                              <Link
                                ...
                                className="group relative flex items-center gap-2.5 overflow-hidden rounded-xl bg-gradient-to-r from-orange-600 via-orange-500 to-orange-600 text-white px-3 py-2.5 no-underline shadow-card hover:shadow-elevated transition-all duration-200"
                              >
                                <span
