...
import { X, ArrowLeft, Sparkles, ArrowDown, Wand2, Ticket, MousePointer2, Download } from "lucide-react";
      ...
      <div className="px-6 pt-7 pb-6 text-center">
        ...
        <div className="mt-5 grid grid-cols-2 gap-2.5 max-w-[280px] mx-auto">
          ...
          <button onClick={() => onPick("theater")}
            className="group relative rounded-xl border border-border bg-background p-2.5 text-left hover:border-[#E3B341]/60 hover:shadow-lg transition-all">
            <div className="h-10 rounded-lg overflow-hidden relative mb-2" style={{ background: "linear-gradient(180deg,#123a2c 0%,#0a241b 100%)" }}>
              ...
              <motion.div initial={{ y: 10 }} animate={{ y: 0 }} transition={{ repeat: Infinity, repeatType: "reverse", repeatDelay: 1.6, duration: 1.2 }}
                className="absolute inset-x-3 bottom-0 h-2 rounded-t-md bg-gradient-to-t from-[#F4D06F]/70 to-transparent" />
            </div>
            <p className="font-heading font-bold text-[11.5px] text-foreground flex items-center gap-1"><Wand2 className="w-3 h-3 text-[#B8860B]" /> The Grand Reveal</p>
          ...
          <button onClick={() => onPick("scratch")}
            ...
            <p className="font-heading font-bold text-[11.5px] text-foreground flex items-center gap-1"><Ticket className="w-3 h-3 text-[#B8860B]" /> Scratch &amp; Shine</p>
