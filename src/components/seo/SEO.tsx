...
const SEO = ({
  ...
  return (
    <Helmet>
      ...
      {/* hreflang intentionally REMOVED: en-PK / ur / x-default all pointed
          to the SAME URL, which is a conflicting language signal Google
          ignores. Re-add only when separate Urdu URLs actually exist. */}
