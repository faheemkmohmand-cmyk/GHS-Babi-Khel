  ...
  return (
    <div className="w-full h-full relative overflow-hidden paper-grain flex flex-col items-center justify-center">
      ...
      <div className={`relative z-10 flex flex-col items-center gap-2 ${big ? "px-6" : "px-4"}`}>
        ...
        {/* Hexagonal monogram with GHS serif initials */}
        <div className="relative">
          <div
            ...
            style={{
              ...
              boxShadow: "0 4px 12px -4px rgba(122, 31, 43, 0.4)",
            }}
          >
            <span
              className={`font-display italic font-bold text-[hsl(45_40%_95%)] leading-none ${big ? "text-3xl" : "text-xl"}`}
              style={{ fontFamily: "var(--font-display)" }}
            >
              GHS
            </span>
          </div>
          {/* Gold ring around the hexagon */}
          <div
            className={`absolute inset-0 ${big ? "w-20 h-20" : "w-14 h-14"}`}
            style={{
              clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)",
              background: "linear-gradient(135deg, hsl(43 60% 58%) 0%, hsl(43 70% 65%) 100%)",
              padding: "2px",
        ...
        <div className="text-center">
          ...
          <p
            className={`font-urdu-display text-primary/75 ${big ? "text-sm mt-0.5" : "text-[10px] mt-0"}`}
            dir="rtl"
          >
  ...
  return (
    <p
      ...
      className={`text-foreground/80 leading-[1.75] line-clamp-4
                  ...
                  ${variant === "featured"
                    ? "text-[15px] first-letter:text-[3.4rem] first-letter:leading-[0.85]"
      ...
      >
        ...
        >
          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="relative h-72 md:h-auto md:min-h-[28rem] overflow-hidden">
              {item.image_url ? (
