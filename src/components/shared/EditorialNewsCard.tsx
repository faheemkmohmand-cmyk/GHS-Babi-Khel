    ...
    >
      ...
      >
        ...
        <div className="relative h-48 overflow-hidden">
          ...
          {item.is_pinned && (
            <span className="absolute top-3 right-3 z-10 inline-flex items-center gap-1 px-2 py-0.5 rounded-sm text-[8px] font-bold uppercase tracking-[0.25em] bg-gradient-to-r from-[hsl(43_70%_48%)] to-[hsl(43_80%_55%)] text-[hsl(348_55%_22%)] shadow-md ring-1 ring-[hsl(43_70%_48%)]/40">
