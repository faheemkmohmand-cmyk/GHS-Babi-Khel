...
const NewsTicker = () => {
  ...
  // (mirrors the same fix applied on /admission and Home.tsx so all three always agree)
  ...
  const admissionItem = isAdmissionEffectivelyOpen
    ? [{
        id: "admission-open",
  ...
  return (
    <div className="bg-gold text-black py-1 overflow-hidden border-y border-black">
      <div className="container mx-auto px-4 flex items-center gap-3">
        ...
        <div
          className="flex items-center gap-1.5 shrink-0 bg-black py-1 pl-4 pr-4 text-xs font-semibold uppercase tracking-wider border border-black text-white -ml-4"
