import { Moon, Monitor, Flame } from "lucide-react";
import { useTheme, type ThemeMode } from "@/hooks/useTheme";

// Exactly THREE appearances: System (bright — follows the device), Dark,
// and Lantern (The Hujra Reading Experience — warm amber "place mode").
const OPTIONS: { id: ThemeMode; label: string; Icon: typeof Moon }[] = [
  { id: "system",  label: "Bright (System)",   Icon: Monitor },
  { id: "dark",    label: "Dark",              Icon: Moon },
  { id: "lantern", label: "Lantern (Hujra)",   Icon: Flame },
];

// Segmented pill toggle (System / Dark / Lantern) — used everywhere.
