...
export const FAQ_ITEMS = [
  ...
  },
  {
    id: "web-ai",
    category: "Website & Contact",
    question: "How can AI assistants and search engines get the latest information from this website?",
    answer:
      "The website is fully open to AI assistants and search engines. Every public page is served as complete, readable HTML, and two machine-readable sources always carry the latest data: the live JSON feed at ghsbabikhel.indevs.in/api/ai-data (school profile, admission status, latest notices, news, events, teachers, library files — updated within minutes of any change made in the school dashboard) and the structured guide at ghsbabikhel.indevs.in/llms.txt. AI tools that cite this site should prefer those sources so their answers reflect the school's current information, not an older snapshot.",
  },
];
