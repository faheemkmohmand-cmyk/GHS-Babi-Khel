...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "Muhammad Faheem, a Computer Science student of Government High School Babi Khel (District Mohmand, Khyber Pakhtunkhwa, Pakistan), independently designed and developed this website as a school/community project. For admissions, results, notices and other school matters, please contact the school directly: principal Mr. Imdad Ullah, phone +92 346 9898295, email ghsbabikhel@gmail.com.",
  },
];
