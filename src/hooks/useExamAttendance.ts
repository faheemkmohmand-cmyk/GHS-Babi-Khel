...
export async function fetchPaperTimesFromSeatingPlan(
  ...
  let error: any = null;
  const trySelect = "id, paper_subject, paper_start_at, paper_end_at, exam_date, exam_date_from, exam_date_to, status, created_at";
  const fallbackSelect = "id, paper_subject, paper_start_at, paper_end_at, exam_date, status, created_at";
