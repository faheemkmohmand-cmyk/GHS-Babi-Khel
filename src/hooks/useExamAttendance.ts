...
export function useScanSeatingAttendance() {
  ...
  return useMutation({
    mutationFn: async (params: {
      ...
      const ASSIGNMENT_SELECT = "id, plan_id, room_id, student_id, student_name, class, class_roll_no, exam_roll_no, seat_label, qr_token, exam_seating_plans!inner(session_id, title, paper_start_at, paper_end_at), exam_seating_rooms!inner(name)";
