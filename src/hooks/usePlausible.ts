...
//
// Plausible Analytics integration for GHS Babi Khel.
//
// SETUP (one-time):
//   1. Go to https://plausible.io → "Add a website" → enter ghsbabikhel.indevs.in
//   2. Copy your domain (e.g. "ghsbabikhel.indevs.in") into VITE_PLAUSIBLE_DOMAIN
...
//   VITE_PLAUSIBLE_DOMAIN=ghsbabikhel.indevs.in
