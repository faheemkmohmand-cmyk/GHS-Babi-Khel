...
function ApplyOnlineIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M4 16L6 18H18L20 16" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round"/>

      {/* Laptop Screen */}
      <rect x="3" y="5" width="18" height="10" rx="1.5" fill="currentColor" fillOpacity="0.18" stroke="currentColor" strokeWidth="1.6"/>

      {/* Screen Content - Form Lines (solid, high-contrast) */}
      <rect x="5.5" y="7" width="8" height="1.3" rx="0.4" fill="currentColor"/>
      <rect x="5.5" y="9.3" width="13" height="1" rx="0.35" fill="currentColor" fillOpacity="0.75"/>
      <rect x="5.5" y="10.8" width="11" height="1" rx="0.35" fill="currentColor" fillOpacity="0.75"/>
      <rect x="5.5" y="12.3" width="6" height="1" rx="0.35" fill="currentColor" fillOpacity="0.75"/>

      {/* Checkmark Circle */}
      <circle cx="17" cy="11" r="2.3" fill="currentColor" stroke="currentColor" strokeWidth="1.1"/>
      <path d="M15.8 11L16.7 12L18.2 10" stroke="white" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/>

      {/* Camera/Webcam */}
      <circle cx="12" cy="4.3" r="0.7" fill="currentColor"/>
    </svg>
  );
}
...
function TrackApplicationIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
      {/* Background Circle */}
      <circle cx="10" cy="10" r="7" fill="currentColor" fillOpacity="0.18" stroke="currentColor" strokeWidth="1.7"/>

      {/* Search Glass Handle */}
      <line x1="15.2" y1="15.2" x2="19.5" y2="19.5" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round"/>

      {/* Inner Elements - Document/List representation (solid, high-contrast) */}
      <rect x="6.5" y="7" width="7" height="1.1" rx="0.3" fill="currentColor" fillOpacity="0.85"/>
      <rect x="6.5" y="9" width="5" height="1.1" rx="0.3" fill="currentColor" fillOpacity="0.65"/>
      <rect x="6.5" y="11" width="6" height="1.1" rx="0.3" fill="currentColor" fillOpacity="0.65"/>

      {/* Status Dot */}
      <circle cx="14.5" cy="8" r="1.9" fill="currentColor" stroke="currentColor" strokeWidth="1"/>
      <path d="M14.5 7V8.2L15.2 8.7" stroke="white" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
function PrintableFormIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M14.5 2.5V5.5C14.5 6.05 14.95 6.5 15.5 6.5H18.5" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" />

      {/* Form lines (solid, high-contrast) */}
      <rect x="7" y="9.3" width="7.5" height="1.1" rx="0.35" fill="currentColor" fillOpacity="0.85" />
      <rect x="7" y="11.6" width="9.5" height="1" rx="0.3" fill="currentColor" fillOpacity="0.65" />
      <rect x="7" y="13.7" width="6" height="1" rx="0.3" fill="currentColor" fillOpacity="0.65" />
      <rect x="7" y="15.8" width="8" height="1" rx="0.3" fill="currentColor" fillOpacity="0.65" />

      {/* Pen, diagonally over bottom-right of the page */}
      <g transform="rotate(45 18 17)">
        <rect x="16.6" y="12.5" width="2.2" height="9" rx="1.1" fill="currentColor" />
