...
function ApplyNowIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M12 3L2 8.5L12 14L22 8.5L12 3Z" fill="white" fillOpacity="0.25" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round"/>
      
      {/* Cap Bottom/Skull part */}
      <path d="M5 10V14C5 16.5 8 18.5 12 18.5C16 18.5 19 16.5 19 14V10" 
        stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round"/>
      
      {/* Tassel String */}
      <path d="M22 8.5V14C22 15 21 15.5 20.5 15.5C20 15.5 19 15 19 14V8.5" 
        stroke="currentColor" strokeWidth="1.2" fill="none"/>
      
      {/* Tassel End */}
      <circle cx="20.5" cy="15.5" r="1.2" fill="currentColor" opacity="0.8"/>
      
      {/* Button on top of cap */}
      <circle cx="12" cy="8.5" r="1.3" fill="currentColor" fillOpacity="0.3" stroke="currentColor" strokeWidth="1"/>
      
      {/* Highlight/Reflection */}
      <path d="M6 7.5L12 4.5L18 7.5" stroke="white" strokeWidth="0.8" strokeLinecap="round" opacity="0.5"/>
    </svg>
  );
}
