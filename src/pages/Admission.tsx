          ...
          <div className="container mx-auto px-4 pt-8 max-w-2xl">
            ...
            {isEffectivelyOpen && (
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0, transition: { delay: 0.1 } }}
                ...
                {[
                  { title: "Class 6–10 Admission", desc: "Fresh admission & migration — middle & high school", icon: BookOpen, color: "from-blue-500 to-blue-700", type: "fresh" as AdmissionType },
                ].map((cat, i) => (
                  <motion.button key={i}
            ...
            >
              ...
              <div>
                ...
                <p>
                  ...
                  (for migration); father's CNIC copy; signed letter from both
                  principals (Class 10 migration).
                </p>
              </div>
              <div>
