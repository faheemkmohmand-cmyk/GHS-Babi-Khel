      ...
      const html = `<!DOCTYPE html><html><head><meta charset="utf-8"><title>${item.pdfTitle}</title>
        <style>
          ...
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .logo-wrap { width: 54px; height: 54px; border-radius: 50%; border: 2.5px solid #f0a55f; overflow: hidden; flex-shrink: 0; background: #faf3e8; display: flex; align-items: center; justify-content: center; }
      ...
      const html = `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Admission Application Form</title>
        <style>
          ...
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .logo-wrap { width: 58px; height: 58px; border-radius: 50%; border: 2.5px solid #f0a55f; overflow: hidden; flex-shrink: 0; background: #faf3e8; display: flex; align-items: center; justify-content: center; }
          .logo-wrap img { width: 100%; height: 100%; object-fit: cover; }
          .header-text { flex: 1; }
        ...
        <div style="margin:6px 0 14px;"><div style="font-size:10px;font-weight:600;letter-spacing:0.3px;color:#7C2D12;margin-bottom:8px;text-transform:uppercase;">Applying for Class <span style="color:#E4650D;">*</span></div>${["6","7","8","9","10"].map(c => checkbox(`Class ${c}`, form.applying_class === c)).join("")}</div>
        <div style="margin:6px 0 16px;"><div style="font-size:10px;font-weight:600;letter-spacing:0.3px;color:#7C2D12;margin-bottom:8px;text-transform:uppercase;">Admission Type <span style="color:#E4650D;">*</span></div>${checkbox("Fresh Admission", form.admission_type === "fresh")}${checkbox("Migration / Transfer (Class 9 & 10 only)", form.admission_type === "migration")}</div>
      ...
      const html = `<!DOCTYPE html><html><head><meta charset="utf-8">
        ...
        <style>
          * { margin:0;padding:0;box-sizing:border-box; }
          ...
          .logo-wrap { width:56px;height:56px;border-radius:50%;border:2.5px solid #f0a55f;overflow:hidden;flex-shrink:0;background:#faf3e8;display:flex;align-items:center;justify-content:center; }
          .logo-wrap img { width:100%;height:100%;object-fit:cover; }
        ...
        <div class="section-title">2&nbsp; &nbsp;Academic Information</div>
        <div style="margin:6px 0 14px;"><div style="font-size:10px;font-weight:600;letter-spacing:0.3px;color:#7C2D12;margin-bottom:8px;text-transform:uppercase;">Applying for Class <span style="color:#E4650D;">*</span></div>${["6","7","8","9","10"].map(c => checkbox(`Class ${c}`, false)).join("")}</div>
        <div style="margin:6px 0 16px;"><div style="font-size:10px;font-weight:600;letter-spacing:0.3px;color:#7C2D12;margin-bottom:8px;text-transform:uppercase;">Admission Type <span style="color:#E4650D;">*</span></div>${checkbox("Fresh Admission", false)}${checkbox("Migration / Transfer (Class 9 & 10 only)", false)}</div>
