  ...
  return (
    <PageLayout>
      <div className="min-h-screen bg-gradient-to-br from-background via-primary/3 to-background pb-16">
        ...
        {/* Sponsored — Adsterra Native Banner. Bottom of the main content
            column, so it renders on every admission view (apply, track,
            success) without interfering with the form flow itself. */}
        <AdsterraNativeBanner className="container mx-auto px-4 pt-2 pb-6" />
