  ...
  const generateOfflineForm = useCallback(() => {
    ...
    try {
      ...
      const html = `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Admission Application Form</title>
        ...
        <div style="margin:6px 0 16px;"><div style="font-size:10px;font-weight:600;letter-spacing:0.3px;color:#0f4c3a;margin-bottom:8px;text-transform:uppercase;">Admission Type <span style="color:#c96b3b;">*</span></div>${checkbox("Fresh Admission")}${checkbox("Migration / Transfer (Class 9 & 10 only)")}</div>
                        ...
                        <div className="space-y-3">
                          ...
                          (
                            <div className="bg-muted/50 border border-border rounded-xl p-3 text-xs text-muted-foreground flex gap-2">
                              <Info className="w-4 h-4 shrink-0 mt-0.5" />
                              <span>Previous school details below are REQUIRED for all applicants at GHS Babi Khel (both Fresh Admission and Migration/Transfer), per our school policy. Please fill in all fields.</span>
                            </div>
                          )
                          {[
