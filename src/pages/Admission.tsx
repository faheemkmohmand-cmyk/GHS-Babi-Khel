...
/**
 * Apply Online Icon - Colorful Realistic Laptop with Form
 * Vibrant gradient-style icon for online application
 */
...
/**
 * Track Application Icon - Colorful Realistic Search with Status
 * Vibrant gradient-style icon for tracking applications
 */
...
/**
 * Apply Now / Graduation Cap Icon - Colorful Realistic Version
 * Vibrant gradient-style graduation cap with golden tassel
 */
              ...
              <div className={`grid grid-cols-1 sm:grid-cols-2 gap-2.5 ${!isEffectivelyOpen ? "opacity-50 pointer-events-none select-none" : ""}`}>
                ...
                >
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-lg bg-transparent border-2 border-[#C96B3B] flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                      <Download className="w-5 h-5 text-[#C96B3B]" />
                    </div>
                    <div className="min-w-0 flex-1">
                      <p className="font-bold text-sm text-[#C96B3B] flex items-center gap-1.5">
                        <span>Download Admission Form</span>
                        <Badge variant="secondary" className="text-[9px] px-1.5 py-0 border-[#C96B3B]/30 text-[#C96B3B]">Printable PDF</Badge>
                      </p>
                      ...
                      <p className="text-[9px] text-muted-foreground font-medium mt-1 flex items-center gap-1">
                        <FileDown className="w-3 h-3 text-[#C96B3B]" /> No pre-filling required
                      </p>
                    </div>
                  </div>
                </button>
