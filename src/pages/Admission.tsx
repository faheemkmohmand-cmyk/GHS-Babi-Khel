                      ...
                      <>
                        ...
                        <div className="space-y-3">
                          ...
                          <button
                            ...
                            disabled={!!downloading}
                            className="w-full flex items-center gap-3 p-3 border-2 border-primary border-dashed bg-transparent hover:bg-primary/10 transition-all text-left disabled:opacity-60"
                          >
                            <div className="w-9 h-9 rounded-lg border-2 border-primary bg-transparent flex items-center justify-center shrink-0">
