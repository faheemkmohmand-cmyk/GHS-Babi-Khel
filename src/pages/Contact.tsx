      ...
      <section className="relative overflow-hidden gradient-hero">
        ...
        <div className="container mx-auto px-4 relative z-10 py-16 md:py-24 text-center">
          ...
          >
            <a
              href={`mailto:${displayEmail}`}
              className="inline-flex items-center gap-2 rounded-full bg-white/10 border border-white/15 px-4 py-2 text-xs sm:text-sm font-medium text-primary-foreground hover:bg-white/15 transition-colors"
            >
            ...
            <span className="inline-flex items-center gap-2 rounded-full bg-white/10 border border-white/15 px-4 py-2 text-xs sm:text-sm font-medium text-primary-foreground">
