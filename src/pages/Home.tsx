  ...
  return (
    ...
    <PageLayout>
      ...
      {/* ══ 10. EDITORIAL DISPATCH (LATEST NEWS) ══
          A PhD-level research-paper-styled news section. The lead story is
          rendered as a 2-col "featured article" (masthead + body), followed
          by up to 2 side stories in compact journal-card form. Each card
          supports an audio "Listen" pill that opens the auto-playing TTS bar.
          Urdu items auto-flip to RTL and use the Urdu narration voice. */}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-10">
            <div className="flex items-end justify-between flex-wrap gap-4">
              ...
              <Link to="/news" className="inline-flex items-center gap-1.5 text-sm font-semibold text-[hsl(348_55%_28%)] hover:gap-2 transition-all">
                View archive <ChevronRight className="w-4 h-4" />
              </Link>
            </div>

            {/* Volume / Issue line — gives the journal feel */}
          ...
          {/* ── Body: featured + side stories ── */}
          {newsLoading ? (
            <div className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <Skeleton className="h-72 md:h-96 rounded-md" />
                <Skeleton className="h-72 md:h-96 rounded-md" />
              </div>
              <div className="grid md:grid-cols-2 gap-6">
            ...
            <>
              ...
              {/* Side stories — up to 2 of the remaining items */}
              {news.length > 1 && (
