        ...
        <m.div style={{ y: heroContentY, opacity: heroOpacity }} className="container mx-auto px-4 relative z-10 pt-0 pb-20 md:pt-2 md:pb-24">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            <m.div initial="hidden" animate="visible" variants={stagger.parent} className="max-w-2xl relative">
              ...
              {/* ── Vertical-chevron banner — sits BEHIND the heading/description ──
                  Symmetric V (arrow pointing right toward the text area).
                    • top center point at (50%, 25%)
                    • right side flush top→bottom
                    • bottom center point at (50%, 75%)
                    • left side flush bottom→top
                  This produces two balanced outward triangles meeting in the
                  middle — a clean left/right symmetric chevron.
              ...
              {settings?.banner_url && !bannerFailed && (
                ...
                >
                  <div
                    ...
                    style={{ clipPath: "polygon(50% 25%, 100% 0%, 100% 100%, 50% 75%, 0% 100%, 0% 0%)" }}
                  >
                    {/* thin gold-cream chevron border, slightly larger than the image so it frames it evenly */}
                    <div
