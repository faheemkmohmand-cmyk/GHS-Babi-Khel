          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            <m.div initial="hidden" animate="visible" variants={stagger.parent} className="max-w-2xl relative">
              ...
              {/* ── Chevron banner — sits BEHIND the heading/description as a backdrop ──
                  Shape: right/top/bottom flush, LEFT edge has a V-notch cut inward
                  (apex at 18% from left, opening to the left). Tweak the 18% to
                  make the V deeper (e.g. 25%) or shallower (e.g. 10%); the top
                  and bottom corners are flush so only that one number changes. */}
              {settings?.banner_url && !bannerFailed && (
                ...
                >
                  <div
                    ...
                    style={{ clipPath: "polygon(0 0, 100% 0, 100% 100%, 0 100%, 18% 50%)" }}
                  >
