              ...
              <m.div variants={stagger.child} className="mt-10 flex flex-wrap gap-4">
                <Link to="/results">
                  <m.button whileHover={{ scale: 1.03, y: -2 }} whileTap={{ scale: 0.97 }}
                    className="inline-flex items-center gap-2 bg-white text-primary font-semibold px-7 py-3.5 rounded-xl border border-gold shadow-md hover:shadow-lg transition-all duration-200 dark:bg-gold dark:text-[hsl(28,70%,10%)] dark:border-transparent dark:shadow-[0_8px_24px_-8px_hsl(30_95%_60%/0.45)]">
