          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            <m.div initial="hidden" animate="visible" variants={stagger.parent} className="max-w-2xl relative">
              ...
              {/* ── Two-arrow diagonal banner — sits BEHIND the heading/description ──
                  Two SEPARATE triangular halves of the same photo, each clipped
                  to its own "arrow" shape, positioned so their pointed tips
                  meet in the exact center of the wrapper:
                    • Piece A (top-right arrow): shows the TOP-LEFT half of the
                      photo, tip pointing down-left toward center.
                    • Piece B (bottom-left arrow): shows the BOTTOM-RIGHT half
                      of the photo, tip pointing up-right toward center.
                  Both pieces reference the same background image at the same
                  size/position (via bg-size + bg-position on a shared-size
                  container) so the two halves line up as one coherent photo,
                  just split into two touching triangles instead of one solid
                  diagonal block.
                ...
                >
                  <div className="relative w-[20rem] h-[20rem] md:w-[31rem] md:h-[31rem] shrink-0 opacity-90">
                    {(() => {
                      ...
                      // Piece A: top-right arrow, tip pointing to bottom-left center
                      const clipA = "polygon(0% 0%, 100% 0%, 100% 100%, 50% 50%)";
                      // Piece B: bottom-left arrow, tip pointing to top-right center
                      const clipB = "polygon(0% 0%, 50% 50%, 100% 100%, 0% 100%)";
                      return (
                        <>
