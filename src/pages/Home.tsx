          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            <motion.div initial="hidden" animate="visible" variants={stagger.parent} className="max-w-2xl">
              <motion.div variants={stagger.child}>
                <span className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm border border-white/30 rounded-full px-4 py-1.5 text-sm text-white shadow-sm">
              ...
              <motion.h1 variants={stagger.child} className="mt-6 text-4xl md:text-6xl lg:text-7xl font-heading font-extrabold leading-[0.95] min-h-[1em] text-white drop-shadow-lg">
                {displayedSchoolName}
                <span className="inline-block w-1 h-[0.85em] bg-white/70 ml-1 align-middle" style={{ animation: "blink 1s step-end infinite" }} />
              </motion.h1>
              <motion.h2 variants={stagger.child} className="mt-4 text-xl md:text-2xl font-heading font-semibold text-white/90 min-h-[2rem] drop-shadow">
                {displayed}
                <span className="inline-block w-0.5 h-6 bg-white/70 ml-1 align-middle" style={{ animation: "blink 1s step-end infinite" }} />
              ...
              <motion.div variants={stagger.child} className="mt-8 flex flex-wrap gap-4">
                ...
                <Link to="/about">
                  <motion.button whileHover={{ scale: 1.03, y: -2 }} whileTap={{ scale: 0.97 }}
                    className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm border border-white/30 text-white font-semibold px-7 py-3.5 rounded-xl shadow-sm hover:bg-white/30 transition-all duration-200">
                    Learn More
                  </motion.button>
                </Link>
              </motion.div>
            ...
            <motion.div ref={statsRef} initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4, duration: 0.6 }} className="hidden lg:grid grid-cols-2 gap-3">
              {[
                ...
                <motion.div key={stat.label} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 + i * 0.1 }}
                  className="bg-white/15 backdrop-blur-md rounded-2xl p-4 border border-white/20 shadow-sm">
