                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      <Link to="/admission">
                        <m.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}
                          className="w-full sm:w-auto px-10 py-5 bg-transparent text-[#C96B3B] border-2 border-[#C96B3B] rounded-2xl font-bold hover:bg-[#C96B3B]/10 transition-all flex items-center justify-center gap-2 text-lg">
