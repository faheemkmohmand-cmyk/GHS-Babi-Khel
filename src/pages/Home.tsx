        ...
        <m.div style={{ y: heroContentY, opacity: heroOpacity }} className="container mx-auto px-4 relative z-10 pt-0 pb-20 md:pt-2 md:pb-24">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            <m.div initial="hidden" animate="visible" variants={stagger.parent} className="max-w-2xl relative">
              ...
              {/* ── Bowtie / X banner — sits BEHIND the heading/description ──
                  Matches the user's traced reference exactly: a single filled
                  polygon shaped like an X/bowtie/hourglass — two triangular
                  wings (left + right) meeting at a pinched center point.
                    polygon(50% 25%, 100% 0%, 100% 100%, 50% 75%, 0% 100%, 0% 0%)
                  This is ONE shape (not two separate pieces), so the photo
                  fills both wings continuously with no seam-visibility issue —
                  verified against the reference by plotting the exact polygon
                  before implementing.
