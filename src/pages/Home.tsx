        ...
        <motion.div style={{ y: heroContentY, opacity: heroOpacity }} className="container mx-auto px-4 relative z-10 py-20 md:py-24 will-change-transform">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            <motion.div initial="hidden" animate="visible" variants={stagger.parent} className="max-w-2xl">
              ...
              {/* Banner image shown inline on mobile, hidden on lg (shown in right column) */}
              <motion.div variants={stagger.child} className="mt-6 lg:hidden">
                <div className="rounded-3xl bg-white border border-[#E5E7EB] p-2 shadow-lg overflow-hidden">
                  {settings?.banner_url ? (
                    <img src={settings.banner_url} alt="School campus" className="w-full h-[200px] object-cover rounded-2xl" loading="eager" decoding="async" fetchPriority="high" />
                  ) : (
                    <div className="w-full h-[200px] rounded-2xl bg-[#E5E7EB] flex items-center justify-center">
            ...
            <motion.div ref={statsRef} initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4, duration: 0.6 }} className="space-y-4">
              <div className="hidden lg:block rounded-3xl bg-white border border-[#E5E7EB] p-2 shadow-lg overflow-hidden">
                {settings?.banner_url ? (
