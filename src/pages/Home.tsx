        ...
        <m.div style={{ y: heroContentY, opacity: heroOpacity }} className="container mx-auto px-4 relative z-10 pt-0 pb-20 md:pt-2 md:pb-24">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            <m.div initial="hidden" animate="visible" variants={stagger.parent} className="max-w-2xl relative">
              ...
              {/* Exam Results — Check your examination results by roll number.
                  Below the hero CTAs: a small white rectangle button with
                  thin blue border that opens the password-gated Report Card
                  modal for bulk result generation (PDF + Excel). */}
              <m.div variants={stagger.child} className="mt-5">
                <p className="text-sm text-muted-foreground mb-2">
                  Check your examination results by roll number
                </p>
                <ReportCardButton />
              </m.div>
            </m.div>
