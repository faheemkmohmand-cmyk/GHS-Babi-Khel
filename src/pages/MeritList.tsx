                            ...
                            <table className="w-full text-sm">
                              ...
                              <tbody>
                                {filteredEntries.map((e) => {
                                  ...
                                  // the withheld students; for those, the top-3 position
                                  // rows are the ones the school hid (both "Hide top 3"
                                  // quick actions target them), so they render as full
                                  // dash rows too — NOT with a dash badge over a real
                                  // name. Re-publishing the list scrubs their data.
                                  // Medals only when nobody is hidden.
                                  const dashRow =
                                    e.hidden ||
                                    (stats.hasHidden && !hasPlaceholderRows && idx < 3);
                                  if (dashRow) {
                                    return (
                                      <tr
