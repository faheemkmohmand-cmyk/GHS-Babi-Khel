...
const MeritListPage = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-background">
      ...
      {/* Sponsored — Adsterra Native Banner. Below the published merit lists
          (students scroll here after finding their name/rank). Async +
          offline-safe: stays empty and invisible without a network. */}
      <AdsterraNativeBanner className="container mx-auto px-4 pb-10" />
    </div>
    </PageLayout>
  );
};
