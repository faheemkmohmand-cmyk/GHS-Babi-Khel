...
const News = () => {
  ...
  const paginated = allNews.slice((page - 1) * PER_PAGE, page * PER_PAGE);
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          {isLoading ? (
            ...
            <>
              {/* Uniform grid — no featured special-case, no FEATURED badge.
                  Every article carries the same editorial weight. */}
              {paginated.length > 0 && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
