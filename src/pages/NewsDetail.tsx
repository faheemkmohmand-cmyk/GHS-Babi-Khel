    ...
    <PageLayout>
      ...
      <article className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        {item.image_url ? (
          ...
          <div className="w-full rounded-2xl border border-border mb-8 overflow-hidden h-52 relative bg-[radial-gradient(circle_at_30%_20%,hsl(var(--primary-light)/0.25),transparent_55%),linear-gradient(160deg,hsl(var(--primary))_0%,hsl(var(--primary-dark))_100%)] flex items-center justify-center">
            <span className="font-display italic text-gold/90 text-5xl" style={{ fontFamily: "var(--font-display)" }}>GBK</span>
          </div>
        )}
