...
<div class="dmc">
  ...
  <div class="header">
    ...
    ${photoUrl ? `<div class="photo-wrap"><img src="${photoUrl}" alt=""/></div>` : `<div class="photo-spacer"></div>`}
  </div>
...
const ResultCard = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      // A result row can have a blank exam_roll_no if the admin generated the
      // roll number in "Exam Roll Numbers" but never attached it when saving
      // this particular result (or it was added via CSV import without that
      // column). Rather than showing "—" on the DMC even though a roll number
      // exists for the student/class, look it up as a fallback.
