...
import { Search, Trophy, Timer, Clock, ExternalLink, AlertCircle, Share2 } from "lucide-react";
                      ...
                      <div className="flex items-center justify-between gap-4 relative z-10">
                        <div className="flex items-center gap-4 min-w-0">
                          ...
                          <div className="min-w-0">
                            <span className="inline-flex items-center bg-white/15 backdrop-blur-sm border border-white/25 rounded-full px-2.5 py-0.5 text-[10px] font-bold tracking-wide uppercase mb-1 max-w-full truncate">
                              {examTypeLabel(r.exam_type)} {r.year} · Class {r.class}
                            </span>
                            <h3 className="font-heading font-extrabold text-lg sm:text-xl drop-shadow-sm truncate">{r.students?.full_name}</h3>
                          </div>
                        </div>
                        {r.exam_roll_no && (
                  ...
                  <div className="flex items-center justify-between gap-4 relative z-10">
                    <div className="flex items-center gap-4 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <h3 className="font-heading font-extrabold text-lg sm:text-xl drop-shadow-sm truncate">{result.name || "—"}</h3>
                      </div>
                    </div>
                    <div className="text-right shrink-0 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl px-3.5 py-2">
