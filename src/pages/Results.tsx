  ...
  return (
    <div>
      ...
      {/* ── Big BISEP-style countdown (pre-announcement state) ──────────────
          While a countdown is active, the Roll No / Search / Reset card is
          HIDDEN — searching is pointless before BISEP has published
          ...
          The moment isLive flips true (picked up within ~1s thanks to the
          adaptive 1s poll in useBisepCurrentExam once the countdown nears
          zero), this block disappears and the search card appears
