...
// ── Exams hub (combines Roll Numbers, Seating, and Date Sheet as sub-tabs) ──
const AdminExams             = lazy(() => import("./tabs/AdminExams"));
// (Live Exam Console is now nested: Exams hub → Seating → Live Console)
...
const tabMap: Record<string, React.LazyExoticComponent<React.ComponentType<any>>> = {
  ...
  // ── Exams section (Date Sheet, Roll Numbers, Seating — one hub component, three deep-links) ──
  "exam-date-sheet":  AdminExams,
  "exam-rolls":       AdminExams,
  "exam-seating":     AdminExams,
  "exam-console":     AdminExams,
  // Old combined-tab id, kept working in case it's bookmarked
  "exams":            AdminExams,
  notes:              AdminNotes,
  videos:             AdminVideos,
  extras:             AdminExtras,
