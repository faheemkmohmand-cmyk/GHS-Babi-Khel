...
const tabMap: Record<string, React.LazyExoticComponent<React.ComponentType<any>> | React.ComponentType<any>> = {
  overview:           AdminOverview,
  notifications:      () => (
    <NotificationsPanel
      title="Admin Notifications"
      subtitle="Live feed of everything happening across the school — admissions, feedback, and your own publish actions."
    />
  ),
