...
const AdminAchievements = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      else { toast.success(editing ? "Updated" : "Added"); qc.invalidateQueries({ queryKey: ["admin-achievements"] }); qc.invalidateQueries({ queryKey: ["achievements"] }); setModalOpen(false); }
    } catch (err: any) {
  ...
  const deleteMut = useMutation({
    ...
    onSuccess: () => { toast.success("Deleted"); qc.invalidateQueries({ queryKey: ["admin-achievements"] }); qc.invalidateQueries({ queryKey: ["achievements"] }); },
  });
