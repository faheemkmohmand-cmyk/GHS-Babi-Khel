...
import {
  ...
  Users, TrendingUp, AlertTriangle, Printer, ArrowUpDown, BarChart3,
  Sunrise,
} from "lucide-react";
import {
...
const AdminAttendance = () => {
  ...
  const reportData = useMemo(() => {
    const rows = students.map((s) => {
      ...
      // Use only days actually marked so far (not the full month, which
      // would wrongly include future/unmarked working days and deflate %).
        ...
        <div className="space-y-4 print:space-y-2">
          <div className="flex flex-wrap items-center gap-2 print:hidden">
            <div className="flex items-center rounded-md border border-slate-300 bg-card overflow-hidden shrink-0">
              ...
              <span className="px-2 h-9 flex items-center justify-center text-sm font-medium whitespace-nowrap min-w-[120px] text-center">
