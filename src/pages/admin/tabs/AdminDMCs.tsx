...
function drawDMC(
  ...
  // (73.5 mm conservatively covers masthead + title + particulars grid +
  // labels — bumped from 71 to reflect the wider masthead→title gap above.)
  const stackBottom = () =>
    17 + 73.5
  ...
  // Extra breathing room before the title — the previous 5.8mm gap put the
  // "DETAILED MARKS CERTIFICATE" baseline almost flush against the double
  // rule, cramping the masthead-to-title transition.
  y += 8.2;
  ...
  doc.setTextColor(...INK);
  drawCentered(doc, "DETAILED MARKS CERTIFICATE", W / 2, y, 1.4);
  y += 5.9;
