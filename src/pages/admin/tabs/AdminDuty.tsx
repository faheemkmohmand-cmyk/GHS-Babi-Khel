...
const AdminDuty = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ── Action toolbar — Publish / Download PDF / Clear ──
          Mobile-friendly: stacks vertically on narrow screens.
          No duplicate buttons: exactly ONE Publish, ONE Download PDF, ONE Clear. */}
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5">
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold text-foreground flex items-center gap-1.5">
              ...
              {justPublished ? "Published! Students can view it now." : "Ready to publish?"}
            </p>
            <p className="text-xs text-muted-foreground mt-0.5">
              {justPublished
                ? "You can download a PDF copy below."
                : "Publish to push assignments to the student-facing Duty board."}
            </p>
          </div>
          {/* Primary: Publish (or Published! state) */}
          <Button
            onClick={handlePublish}
            disabled={publishing}
            className={`h-11 px-5 rounded-xl font-semibold gap-2 shrink-0 ${
              justPublished
          ...
          {/* Secondary: Publish + Download PDF (convenience) */}
          <Button
            onClick={handlePublishAndDownload}
            disabled={publishing}
            variant="outline"
            className="h-11 px-5 rounded-xl font-semibold gap-2 shrink-0 border-2 border-blue-300 dark:border-blue-800 text-blue-700 dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-950/40"
          >
            {publishing ? (
          ...
          {/* Tertiary: Download PDF only (no re-publish) */}
          <Button
            onClick={handleDownloadPDF}
            variant="outline"
            className="h-11 px-4 rounded-xl font-semibold gap-2 shrink-0 border-2 border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800"
            title="Download current duty board as PDF"
          >
          ...
          <Button
            ...
            className="h-11 px-4 rounded-xl font-semibold gap-2 shrink-0 border-2 border-red-200 dark:border-red-900 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/30"
          >
