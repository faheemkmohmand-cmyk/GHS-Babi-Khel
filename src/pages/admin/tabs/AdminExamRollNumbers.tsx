...
const AdminExamRollNumbers = () => {
  ...
  const downloadPrint = async () => {
    ...
    for (const slip of ordered) {
      ...
      const qrDataURL = await QRCode.toDataURL(qrData, { width: 300, margin: 1, errorCorrectionLevel: "M", color: { dark: "#000000", light: "#FFFFFF" } });
  ...
  const exportAttendancePDF = () => {
    ...
    autoTable(doc, {
      ...
      body: tableBody,
      headStyles: { fillColor: [0, 0, 0], textColor: [255, 255, 255], fontStyle: "bold", fontSize: 8, halign: "center", cellPadding: 3.5 },
      bodyStyles: { fontSize: 8, cellPadding: 3, valign: "middle" },
      columnStyles: {
        0: { cellWidth: 10, halign: "center" },
        1: { cellWidth: 20, halign: "center" },
        2: { cellWidth: 24, halign: "center", fontStyle: "bold" },
        3: { cellWidth: 50, halign: "left", overflow: "linebreak" },
      ...
      didParseCell: (data: any) => {
        if (data.section === "body" && data.column.index === 4) {
          ...
          if (val === "Present") { data.cell.styles.textColor = [0, 0, 0]; data.cell.styles.fontStyle = "bold"; }
          else if (val === "Absent") { data.cell.styles.textColor = [0, 0, 0]; data.cell.styles.fontStyle = "normal"; }
          else if (val === "Leave") { data.cell.styles.textColor = [80, 80, 80]; data.cell.styles.fontStyle = "italic"; }
        }
      },
