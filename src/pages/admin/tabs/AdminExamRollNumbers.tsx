...
const AdminExamRollNumbers = () => {
  ...
  const { data: overviewData = [], isLoading: loadingOverview } = useExamAttendanceOverview(attTab === "overview" ? attSession : undefined, attTab === "overview" ? (isAllClassesMode ? undefined : attClass) : undefined);
  ...
  const handleInitSheet = () => {
    ...
    if (isAllClassesMode) {
      ...
      for (const cls of Object.keys(byClass)) {
        ...
        if (!subj) continue;  // skip classes with no subject selected
    ...
    <div className="space-y-5" style={{ contain: "layout style" }}>
      ...
      {mainTab === "attendance" && (
        <>
          ...
          {/* ── OVERVIEW TAB ── */}
          {/* In All-Classes mode, the overview shows ALL classes in the session. */}
