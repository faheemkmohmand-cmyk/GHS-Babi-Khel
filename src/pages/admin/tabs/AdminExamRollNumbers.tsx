...
function QRScanner({ onScan, enabled }: { onScan: (data: string) => void; enabled: boolean }) {
  ...
  const start = useCallback(async () => {
    ...
    // was already granted.
    const waitTime = isMobile ? 900 : 400;
              ...
              <Card className="border-blue-200 dark:border-blue-500/30">
                ...
                <CardContent className="space-y-3">
                  ...
                  <p className="text-[11px] text-muted-foreground leading-relaxed">
                    Slips are published the moment you set the countdown — students see a live timer on the Roll No. Slip page and in the navbar, and their slips appear automatically the second it reaches zero. No "Publish Now" needed at the end.
                  </p>
                </CardContent>
              </Card>
