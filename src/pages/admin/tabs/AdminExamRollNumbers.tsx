...
const AdminExamRollNumbers = () => {
  ...
  const downloadPrint = async () => {
    ...
    const drawSlip = (slip: ExamRollEntry, x: number, y: number) => {
      ...
      const tableBottomLimit = y + h - 24; // stay above signature + instructions block
      ...
      // ── FOOTER INSTRUCTIONS (6 numbered lines) ──
      const instrTopY = y + h - 21;
      ...
      instructions.forEach((line, i) => {
        doc.text(line, x + 4, instrTopY + 3.2 + i * 3);
      });
    };
