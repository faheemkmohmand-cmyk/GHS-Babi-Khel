...
import { UserCog, Clock, Search, Filter, Star, Trophy, BookOpen, Sparkles, Crown, Medal, Award, ChevronDown, ChevronUp, LayoutGrid, Timeline, Download, Pin, PinOff } from "lucide-react";
  ...
  const handleTogglePin = async (q: DailyQuote) => {
    try {
      await upsert.mutateAsync({ 
        id: q.id, 
        ...q, 
        is_pinned: !(q as any).is_pinned 
      });
      toast.success((q as any).is_pinned ? "Unpinned" : "Pinned to top");
