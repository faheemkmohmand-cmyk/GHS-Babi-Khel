        ...
        <div className="relative z-10">
          ...
          <div className="mt-5 flex items-center justify-between gap-3">
            ...
            <Link
              ...
              className="w-10 h-10 rounded-xl bg-white/[0.08] border border-white/10 flex items-center justify-center shrink-0 hover:bg-white/[0.16] hover:border-gold/40 transition-all duration-200"
            >
              <Shield className="w-[18px] h-[18px] text-white/90" />
            </Link>
          </div>
        </div>
      </div>
