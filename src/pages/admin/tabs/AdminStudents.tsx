      ...
      <Dialog open={promotionOpen} onOpenChange={(open) => { setPromotionOpen(open); if (!open) setPromotionPreview(null); }}>
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4 py-1">
            ...
            {/* Exam + Year to determine pass/fail */}
            <div className="flex items-center gap-3">
              <div className="flex-1">
                <Label className="text-xs text-muted-foreground mb-1 block">Based on Exam</Label>
                <Select value={promotionExamType} onValueChange={v => { setPromotionExamType(v); setPromotionPreview(null); }}>
                  <SelectTrigger><SelectValue /></SelectTrigger>
                  <SelectContent>
                    {(["6","7","8"].includes(promotionFrom)
              ...
              <div className="flex-1">
                ...
                <Select value={String(promotionYear)} onValueChange={v => { setPromotionYear(Number(v)); setPromotionPreview(null); }}>
                  <SelectTrigger><SelectValue /></SelectTrigger>
                  <SelectContent>
                    {[0,1,2].map(offset => {
