...
const AdminTimetables = () => {
  ...
  // but the admin still needs to assign them for when they return, or the
  // admin may have simply forgotten to tick the "Active" switch when adding
  // them. Inactive teachers are shown greyed out in the dropdown below but
  // are still selectable. Public-facing pages (homepage, public Teachers
  // page, student dashboard) keep using useTeachers() without this flag, so
  // they only show active teachers to visitors/students.
