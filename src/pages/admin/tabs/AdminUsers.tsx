...
// Only these two roles are available when creating/editing users.
// "teacher" was removed per site-owner request (Teacher Dashboard no
// longer exists) — new users can only be "admin" or "student". "user" and
// "parent" were removed earlier per request — they're not used in the
// school's workflow. Existing profiles with any of these legacy roles are
// still visible in the list (for backwards compatibility) but can't be
// newly assigned.
...
const AdminUsers = () => {
  ...
  // ── Fetch all users (EXCLUDE rejected - they were deleted or shouldn't appear) ──
