                      ...
                      <TableCell>
                        <div className="flex items-center gap-2.5">
                          {(() => {
                            ...
                            return u.avatar_url && !userImgError ? (
                              <img src={u.avatar_url} alt={`${u.full_name || "User"}'s avatar`} className="w-8 h-8 rounded-full object-cover shrink-0" onError={() => setUserImgError(true)} loading="lazy" decoding="async" />
                            ) : (
