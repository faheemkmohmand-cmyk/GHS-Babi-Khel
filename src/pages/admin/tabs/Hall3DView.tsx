  ...
  useEffect(() => {
    ...
    if (mcqTimer?.status === "finished") {
      ...
      if (sirenFiredForRef.current !== finishedAt) {
        ...
        // Auto-off after 15s. setTimeout is fine — the iframe also self-
        // disarms after the same duration, so even if this tab is closed
        // the siren won't stay on forever.
        const t = setTimeout(() => {
