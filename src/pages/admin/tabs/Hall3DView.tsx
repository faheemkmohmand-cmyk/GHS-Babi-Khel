  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black overflow-hidden">
      ...
      {/* ── Right info panel (Feature 5: Seat Desk Sticker Visualization) ──
          FULL-WIDTH on mobile (calc(100vw-1rem)) so student details never
          get cut off. QR is stacked ABOVE the details on mobile, side-by-side
          on desktop. */}
      {clickedAssignment && (
        <div className="absolute top-20 sm:top-24 left-2 right-2 sm:left-auto sm:right-4 z-10 w-[calc(100vw-1rem)] sm:w-[340px]">
          <div className="bg-black/85 backdrop-blur-md border border-white/10 rounded-2xl p-3 sm:p-4 space-y-3 text-white">
            ...
            {/* QR + key details — stacked on mobile, side-by-side on desktop */}
