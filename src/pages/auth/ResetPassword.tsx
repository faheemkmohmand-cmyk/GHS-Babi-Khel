...
const ResetPassword = () => {
  ...
  useEffect(() => {
    ...
    // Supabase sends a hash like:
    //   #access_token=...&expires_in=...&token_type=bearer&type=recovery
    // If the hash is missing or doesn't contain type=recovery, the user
    // navigated here directly — redirect to sign-in.
    const hash = window.location.hash;
    if (!hash || !hash.includes("type=recovery")) {
      // Give a brief moment in case Supabase is still parsing the URL
