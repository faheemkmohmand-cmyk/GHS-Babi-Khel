...
const SignUp = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Problem 25: Sign up with Supabase (email confirmation enabled)
      ...
      if (authData.user) {
        await supabase.from("profiles").upsert({
          ...
          email_verified: false, // Problem 25: Requires email verification
        }, { onConflict: "id" });
      }
        ...
        >
          <div className="bg-card rounded-2xl shadow-elevated p-8 text-center">
            ...
            <div className="space-y-3 text-sm text-muted-foreground mb-6">
              ...
              {/* Problem 25: Email Verification Notice */}
              ...
              <div className="p-3 rounded-lg bg-yellow-50 dark:bg-yellow-500/10 border border-yellow-200 dark:border-yellow-500/20">
                <p className="text-xs text-yellow-800 dark:text-yellow-400">
                  ⏳ An administrator will also need to approve your account before you can access all features.
                </p>
              </div>
