            ...
            >
              <div className="h-40 overflow-hidden bg-secondary">
                {item.image_url ? (
                  ...
                  <div className="w-full h-full gradient-hero flex items-center justify-center"><Bell className="w-8 h-8 text-white/40" /></div>
                )}
              </div>
              <div className="p-4">
...
// ─── School news only (World News removed) ─────────────────────────────────────
const NewsTab = () => (
  <div className="space-y-4">
    <SchoolNewsTab />
  </div>
