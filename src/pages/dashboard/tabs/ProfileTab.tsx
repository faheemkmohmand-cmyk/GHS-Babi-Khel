...
const ProfileTab = () => {
  ...
  // Image error state for handling broken Cloudinary URLs
  const [avatarImgError, setAvatarImgError] = useState(false);

  // Validate the avatar URL to detect broken Cloudinary links early
  ...
  const handleAvatarUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    refreshProfile();
    setAvatarImgError(false); // Reset error state on new upload
    setUploading(false);
  };
      ...
      <div className="bg-card rounded-xl p-6 shadow-card">
        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            ...
            {validatedAvatarUrl && !avatarImgError ? (
              <img 
              ...
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-primary-foreground text-2xl font-heading font-bold">
