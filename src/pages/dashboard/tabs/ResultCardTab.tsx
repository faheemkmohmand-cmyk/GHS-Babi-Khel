    ...
    <div className="space-y-5">
      <div>
        <h2 className="text-2xl font-heading font-bold text-foreground flex items-center gap-2">
          ...
          {results.length > 0 ? `Result - ${results[0].exam_type} ${results[0].year}` : "Result"}
        </h2>
        <p className="text-sm text-muted-foreground mt-0.5">Search your result by exam roll number</p>
      </div>
