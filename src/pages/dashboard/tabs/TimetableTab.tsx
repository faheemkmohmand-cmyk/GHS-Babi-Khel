...
import { Download, Clock, MapPin, Video, ChevronRight, CalendarDays, UserCheck } from "lucide-react";
                    ...
                    {days.map((day) => {
                      ...
                      return (
                        <td key={day} className={`px-2 py-2 ${day === today ? "bg-primary/5" : ""}`}>
                          <div className={`rounded-lg border p-2 ${getSubjectColor(entry.subject)} ${sub ? "ring-1 ring-amber-400/50" : ""}`}>
