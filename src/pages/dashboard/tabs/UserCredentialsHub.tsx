...
import { CreditCard, ShieldCheck, Shield, Download, ChevronDown, ChevronUp, BadgeCheck, GraduationCap, RefreshCw, Loader2, X } from "lucide-react";
...
function UserMonitorPassView() {
  ...
  return (
    <div className="space-y-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {displayed.map(p => (
            <div key={p.id} className="bg-card rounded-2xl border border-blue-200 dark:border-slate-700 overflow-hidden shadow-sm group">
              ...
              {/* Pass info + single Save button (no duplicates) */}
      ...
      {/* Full-screen preview overlay — always-tappable Close + Download */}
      {preview && (
        <div
        ...
        >
          ...
          {/* Bottom action bar — single Download button */}
          <div className="shrink-0 p-4 bg-black/60 backdrop-blur-sm">
            <button
