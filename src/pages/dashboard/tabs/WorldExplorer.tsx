...
export default function WorldExplorer() {
  ...
  useEffect(() => {
    const fields = [
      "cca2","cca3","name","capital","population","area","region","subregion",
      "languages","currencies","borders","flags","coatOfArms","latlng",
      "timezones","continents","fifa","tld","independent","unMember",
    ].join(",");
