...
import {
  ...
  Brain, ClipboardCheck, Code2, PencilLine
} from "lucide-react";
      ...
      {tab==="content" && (
        <Card>
          <CardContent className="pt-5 space-y-4">
            ...
            {/* Content editor — two interchangeable modes, same underlying HTML value */}
            <div>
              ...
              {editorMode === "rich" ? (
                ...
                <>
                  ...
                  />
                  <p className="text-[11px] text-muted-foreground mt-1.5">
                    ⚡ Faster on mobile — paste ready-made HTML and it renders live below, using the same renderer students see. Switch back to Rich Text anytime; both modes edit the same content.
                  </p>
                </>
              )}
            </div>
