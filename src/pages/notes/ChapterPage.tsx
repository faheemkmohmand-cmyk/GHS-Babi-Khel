      ...
      <div className={`lg:hidden fixed left-0 right-0 z-40 bg-card/95 backdrop-blur-sm border-t border-border flex items-stretch ${
        ...
        <button onClick={() => setShowAiAssistant(true)} aria-label="AI Study Buddy"
          ...
          <span className="relative">
            ...
            <span className="absolute -top-1.5 -right-1.5 w-3.5 h-3.5 rounded-full bg-primary border border-background flex items-center justify-center text-[8px] font-bold text-white">AI</span>
          </span>
      ...
      <div className="hidden lg:flex fixed bottom-8 right-3 z-40 flex-col gap-2 items-end">
        ...
        <button onClick={() => setShowAiAssistant(true)} title="AI Study Buddy"
          ...
          <span className="relative w-12 h-12 rounded-full shadow-lg flex items-center justify-center transition-colors text-white hover:opacity-90"
            ...
            <span className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-primary border-2 border-background flex items-center justify-center text-[10px] font-bold text-white">AI</span>
          </span>
        </button>
