    ...
    <PageLayout>
      ...
      <div className="max-w-5xl mx-auto px-3 md:px-4 py-6 md:py-8 flex gap-6 md:gap-8 pb-32 lg:pb-8">
        ...
        <main className="flex-1 min-w-0">
          ...
          {/* Enhanced Gamification Bar with session tracking */}
          {user && (
          ...
          {/* Collapsible Notes Leaderboard Section */}
          <div className="mt-8 border-t border-border pt-6">
            <button
              onClick={() => setShowLeaderboard(!showLeaderboard)}
              className="w-full flex items-center justify-between p-4 bg-gradient-to-r from-yellow-50 to-amber-50 dark:from-yellow-950/20 dark:to-amber-950/20 rounded-2xl border border-yellow-200 dark:border-yellow-800 hover:shadow-md transition-all group"
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className="font-bold text-foreground">🏆 Leaderboard & Badges</p>
                  <p className="text-xs text-muted-foreground">See how you rank against classmates</p>
                </div>
              </div>
              <ChevronRight className={`w-5 h-5 text-muted-foreground transition-transform ${showLeaderboard ? 'rotate-90' : ''}`} />
            </button>
