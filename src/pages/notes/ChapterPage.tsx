...
import {
  ...
  Flag, Star, Award, Lock, Headphones
} from "lucide-react";
import {
...
const ChapterPage = () => {
  ...
  return (
    <PageLayout>
      ...
      {user && <AnnotationOverlay chapterId={chapter.id} contentRef={contentRef} />}

      {/* Floating action buttons — single clean vertical stack, bottom-right.
          Each button is solid-colored with a label visible on hover (desktop) and always (mobile). */}
