...
import NotesGamificationBar from "@/components/notes/NotesGamificationBar";
...
const ChapterPage = () => {
  ...
  const toggleBookmark = async () => {
    ...
    if (next) await awardPoints(user.id, 5).catch(e => console.warn('[ChapterPage] awardPoints(5) bookmark failed:', e));
  };
    ...
    <PageLayout>
      ...
      <div className="max-w-5xl mx-auto px-3 md:px-4 py-6 md:py-8 flex gap-6 md:gap-8 pb-32 lg:pb-8">
        ...
        <main className="flex-1 min-w-0">
          ...
          {/* Gamification + Leaderboard — full bar with leaderboard access */}
          {user && (
            <NotesGamificationBar
