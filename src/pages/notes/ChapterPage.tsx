    ...
    <PageLayout>
      ...
      {/* Floating action buttons.
          Desktop (lg+): unchanged vertical stack, bottom-right, in this order:
            1. Wikipedia Assistant  2. Pomodoro  3. Audio  4. Flashcards  5. Annotations
      ...
      <div className={`lg:hidden fixed left-0 right-0 z-40 bg-card/95 backdrop-blur-sm border-t border-border flex items-stretch ${
        ...
        <button onClick={() => setShowWikiAssistant(true)} aria-label="Wikipedia Study Assistant"
          className="flex-1 flex flex-col items-center justify-center gap-0.5 py-2 relative">
          <span className="relative">
            <BookOpen className="w-5 h-5" style={{ color: subject.color }} />
            <span className="absolute -top-1.5 -right-1.5 w-3.5 h-3.5 rounded-full bg-indigo-800 border border-background flex items-center justify-center text-[8px] font-bold text-white">W</span>
          </span>
          <span className="text-[9px] font-semibold text-muted-foreground">Wiki</span>
        </button>
