...
const NotesPage = () => {
  ...
  return (
    <PageLayout>
      ...
      {/* ─── Sponsored — Adsterra Native Banner (between/below the study
            materials list; loads async, empty & invisible offline) ─── */}
      <AdsterraNativeBanner className="max-w-6xl mx-auto px-4 pb-12" />
    </PageLayout>
  );
};
