    ...
    <PageLayout>
      ...
      <section className="relative overflow-hidden py-5 sm:py-7 px-4" style={{ background: `linear-gradient(135deg, ${subject.color}, ${subject.color}bb)` }}>
        ...
        <div className="relative max-w-4xl mx-auto">
          <Link to="/notes" className="inline-flex items-center gap-1 text-white/80 hover:text-white text-xs mb-3 transition-colors">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <h1 className="text-xl sm:text-2xl md:text-3xl font-black text-white leading-tight">{subject.name}</h1>
              <p className="text-white/80 text-xs sm:text-sm mt-0.5 line-clamp-1">{subject.description}</p>
              <div className="flex items-center gap-2 mt-1.5">
                <span className="text-[10px] bg-white/20 text-white px-2 py-0.5 rounded-full">Class {subject.class_level}</span>
                <span className="text-[10px] bg-white/20 text-white px-2 py-0.5 rounded-full">{chapters.length} Chapters</span>
              </div>
            </div>
          </div>
