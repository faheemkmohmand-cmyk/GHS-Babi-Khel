                    ...
                    <div className={`group relative bg-card border rounded-xl p-3 hover:shadow-md transition-all duration-200 hover:border-[${subject.color}]/50 ${done ? "border-green-200 dark:border-green-800/40" : "border-border"}`}>
                      ...
                      <div className="pl-3 flex items-center gap-3">
                        ...
                        <div className="w-9 h-9 rounded-lg flex items-center justify-center shrink-0 font-black text-sm"
                          style={{ backgroundColor: done ? "#16a34a" : subject.color, color: done ? "#ffffff" : getReadableTextColor(subject.color) }}>
                        ...
                        <div className="flex items-center gap-1 text-xs font-semibold px-2.5 py-1.5 rounded-lg shrink-0 group-hover:opacity-90 transition-opacity"
                          style={{ backgroundColor: subject.color, color: getReadableTextColor(subject.color) }}>
