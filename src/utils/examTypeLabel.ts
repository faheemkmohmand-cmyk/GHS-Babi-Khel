...
// "Annual-II" and these are now also the labels shown to users directly
// (no more "Mid-Term" / "Final-Term" renaming).
//
...
/** Same as examTypeLabel, but also normalizes "Annual-I"/"Annual-II"
 *  substrings inside longer strings (kept for backward compatibility;
 *  no longer renames them). */
